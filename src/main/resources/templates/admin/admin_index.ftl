...
<div class="content-wrapper">
    ...
    <section class="content container-fluid" id="animated-content">
                    ...
                    <form class="form-horizontal" id="widgetsOption">
                        <div class="box-body">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <!--访问记录-->
                                <div class="form-group">
                                    <label for="widgetVisitsLastest" class="col-sm-4 control-label"><@spring.message code='admin.index.widgets.visits-lastest' />：</label>
                                    <div class="col-sm-8 control-radio">
                                        <div class="pretty p-default p-round">
                                            <input type="radio" name="widget_visitslastest" id="widgetVisitsLastest" value="true" ${((options.widget_visitslastest!'true')=='true')?string('checked','')}>
                                            <div class="state p-primary">
                                                <label><@spring.message code='common.radio.display' /></label>
                                            </div>
                                        </div>
                                        <div class="pretty p-default p-round">
                                            <input type="radio" name="widget_visitslastest" id="widgetVisitsLastest" value="false" ${((options.widget_visitslastest!'true')=='false')?string('checked','')}>
                                            <div class="state p-primary">
                                                <label><@spring.message code='common.radio.hide' /></label>
                                            </div>
                                        </div>
        ...
        <div class="row">
            ...
            <!--访问记录-->
            <#if (options.widget_visitslastest!'true')=='true'>
            <div class="col-lg-6 col-xs-12" id="widgetVisitLastestBody">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><@spring.message code='admin.index.widgets.visits-lastest' /></h3>
                        <div class="box-tools">
                            <div class="btn-group">
                                <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <i class="fa fa-bars"></i></button>
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="javascript:void(0)" onclick="halo.layerModal('/admin/visits','<@spring.message code="admin.index.widgets.text.all-visits" />')"><@spring.message code='common.btn.view-all' /></a></li>
                                    <li><a href="/admin/visits/clear"><@spring.message code='admin.index.widgets.btn.clear-visits' /></a></li>
                                </ul>
                                <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
