...
import ink.helloworld.halo.model.dto.BackupDto;
import ink.helloworld.halo.model.dto.Theme;
import ink.helloworld.halo.model.enums.CommonParamsEnum;
...
public class HaloUtils {
    ...
    public static String baiduPost(String blogUrl, String token, String urls) {
        Assert.hasText(blogUrl, "halo url must not be blank");
