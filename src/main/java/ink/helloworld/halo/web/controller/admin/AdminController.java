...
import ink.helloworld.halo.model.domain.*;
import ink.helloworld.halo.model.domain.*;
...
import ink.helloworld.halo.service.*;
import ink.helloworld.halo.model.enums.*;
import ink.helloworld.halo.service.*;
...
public class AdminController extends BaseController {
    ...
    public String index(Model model) {
        ...
        //查询访问记录
        final List<Visits> visitsLatest = visitsService.findVisitsLatest();
        model.addAttribute("visits", visitsLatest);
        ...
        //在线人数
        model.addAttribute("onlineCount", SessionUtil.getSessionSize());
